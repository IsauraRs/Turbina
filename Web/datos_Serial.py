...
def testc():
    ...
    while True:
        ...
        if len(arduino_lectures) ==5:    
            #time.sleep(3)
            print("RPM: "+str(arduino_lectures[1])+" diff: "+str(arduino_lectures[2])+" Voltaje: "+str(arduino_lectures[3])+" Tiempo: "+str(arduino_lectures[4])+" Pot Digt: "+str(arduino_lectures[0]))
